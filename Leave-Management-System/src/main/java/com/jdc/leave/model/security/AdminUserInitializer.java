package com.jdc.leave.model.security;
...
public class AdminUserInitializer {
	...
	private boolean isNoAdminUser() {
		...
		return new NamedParameterJdbcTemplate(dataSource).queryForObject("select count(id) from account where role = :role", Map.of("role","Admin"), Long.class)==0;
	}
